    ...
    return (
        <>
            ...
            <VideoPopup
                ...
                videoId={"_YFzgnuiMlk?si=kgaOPq2FyoaUmT7k"}
            />
            {/* video modal end */}
                            ...
                            <div className="col-lg-4">
                                <div className="courses-sidebar-area sticky-style">
                                    <div className="courses-items">
                                        <div className="courses-image">
                                            <img src="FCImage/Coures-10.png" alt="img" />
                                            <h3 className="courses-title">CLB7冲刺</h3>
                                            <h4 className="topic-title">高分冲刺保障</h4>
                                        ...
                                        <div className="courses-content">
                                            <h3>咨询价格</h3>
                                            <p>
                                                现任考官直授的CLB7冲刺班，98%通过率保障，助您快速达到移民要求分数。
                                            </p>
                                            <div className="courses-btn">
                                                <Link href="/contact" className="theme-btn">立即咨询</Link>
                                                <Link href="/contact" className="theme-btn style-2">预约试听</Link>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="courses-category-items">
                                        ...
                                        <ul>
                                            ...
                                            <span>
                                                ...
                                                <span className="text">考官 ABLE</span>
                                            </li>
                                            <li>
                                            <span>
                                                ...
                                                <span className="text">120课时</span>
                                            </li>
                                            <li>
                                            <span>
                                                ...
                                                <span className="text">8-12周</span>
                                            </li>
                                            <li>
                                            <span>
                                            ...
                                            <span>
                                                ...
                                                <span className="text">法语+中文</span>
                                            </li>
                                            <li>
                                            <span>
                                                ...
                                                <span className="text">CLB7 (移民达标)</span>
                                            </li>
                                            <li>
                                            <span>
                                            ...
                                            <span>
                                                ...
                                                <span className="text">100%真题训练</span>
                                            </li>
                                        </ul>
                                        <Link href="/contact" className="share-btn"><i
                                            className="fas fa-share"></i> 分享此课程</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
